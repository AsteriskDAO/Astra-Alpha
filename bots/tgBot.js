...
// Function to get or create bot instance
function getBotInstance() {
  if (!botInstance) {
    botInstance = new Bot(TG_BOT_API_KEY);
...
// Function to safely start the bot
...
// Move all command registrations to a separate function
